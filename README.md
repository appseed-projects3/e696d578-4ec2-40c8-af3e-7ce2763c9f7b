...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-17 09:18`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e696d578-4ec2-40c8-af3e-7ce2763c9f7b.git
$ cd e696d578-4ec2-40c8-af3e-7ce2763c9f7b
```
